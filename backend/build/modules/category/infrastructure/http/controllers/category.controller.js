...
class CategoryController {
	...
	getOneByName(req, res, next) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			try {
				const categoryFound = yield this.categoryService.findByName(
					name
				);
				return res.status(200).json(categoryFound);
			} catch (error) {
	...
	createOne(req, res, next) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			try {
				const categoryCreated = yield this.categoryService.createOne(
					Object.assign(Object.assign({}, categoryData), {
	...
	updateOneById(req, res, next) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			const categoryData = req.body;
			try {
				const categoryUpdated = yield this.categoryService.updateById(
					id,
					categoryData
				);
				const httpResponse = {
	...
	deleteOneById(req, res, next) {
		return __awaiter(this, void 0, void 0, function* () {
			const { id } = req.params;
			try {
				const categoryDeleted = yield this.categoryService.deleteById(
					id
				);
				const httpResponse = {
	...
	deleteSeveral(req, res, next) {
		return __awaiter(this, void 0, void 0, function* () {
			const { ids } = req.body;
			const categoriesDeleted = yield this.categoryService.deleteMany(
				ids
			);
			try {
